...
```bash
git clone practicum-recommender-system.git
cd similar-movies-recommender
```
...
[`Makefile`](practicum-recommender-system/blob/master/Makefile) contains a lot of functions for faster development.
...
More information [about docker](practicum-recommender-system/tree/master/docker).
